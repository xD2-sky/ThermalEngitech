    ...
    case 'boiler':
      return (
        <svg viewBox="0 0 320 200" fill="none" className="w-full h-full max-h-48 drop-shadow-sm opacity-90">
          ...
          <line x1="86" y1="85" x2="234" y2="85" stroke="#2E76C9" strokeWidth="2.5" strokeDasharray="5 5" />
          <line x1="86" y1="100" x2="234" y2="100" stroke="#2E76C9" strokeWidth="2.5" />
          <line x1="86" y1="115" x2="234" y2="115" stroke="#2E76C9" strokeWidth="2.5" strokeDasharray="5 5" />

          {/* Core steam exit nozzle drum */}
          <rect x="145" y="28" width="30" height="28" fill="#17222E" stroke="#1F5FA8" strokeWidth="2" strokeLinejoin="bevel" />
          <line x1="145" y1="36" x2="175" y2="36" stroke="#2E76C9" strokeWidth="2" />
          ...
          <path d="M50 115 H70" stroke="#5B9BD9" strokeWidth="3.5" />
          <path d="M250 90 H270" stroke="#EF4444" strokeWidth="3.5" />

          {/* Heavy Base structural support blocks for site installation */}
          <rect x="100" y="145" width="20" height="15" fill="#1B2A3D" stroke="#1F5FA8" strokeWidth="2" />
          <rect x="200" y="145" width="20" height="15" fill="#1B2A3D" stroke="#1F5FA8" strokeWidth="2" />
          <line x1="85" y1="160" x2="235" y2="160" stroke="#1F5FA8" strokeWidth="4.5" />
        </svg>
      );
    case 'heater':
      return (
        <svg viewBox="0 0 320 200" fill="none" className="w-full h-full max-h-48 drop-shadow-sm opacity-90">
          ...
          <path d="M80 75 Q95 65 110 75 T140 75 T170 75 T200 75 T230 75" fill="none" stroke="#1F5FA8" strokeWidth="3" />
          <path d="M80 95 Q95 85 110 95 T140 95 T170 95 T200 95 T230 95" fill="none" stroke="#1F5FA8" strokeWidth="3" />
          ...
          <rect x="35" y="75" width="25" height="50" fill="#1B2A3D" stroke="#1F5FA8" strokeWidth="3.5" />
          ...
          <path d="M100 140 H85 V165" stroke="#1F5FA8" strokeWidth="3" />
          <path d="M76 150 L85 141 L94 150 Z" fill="#1F5FA8" />
        </svg>
      );
    case 'generator':
      return (
        <svg viewBox="0 0 320 200" fill="none" className="w-full h-full max-h-48 drop-shadow-sm opacity-90">
          ...
          <path d="M130 55 C130 65 190 65 190 75 C190 85 130 85 130 95 C130 105 190 105 190 115 C190 125 130 125 130 135" fill="none" stroke="#1F5FA8" strokeWidth="3" strokeLinecap="round" />

          {/* Quick-fit flow connections */}
          <rect x="75" y="55" width="25" height="18" fill="#17222E" stroke="#5B6472" strokeWidth="1.5" />
          <text x="50" y="66" fill="#5B9BD9" className="text-[9px] font-sans">IN</text>
          ...
          {/* Chimney escape port */}
          <rect x="145" y="10" width="30" height="20" rx="2" fill="#17222E" stroke="#1F5FA8" strokeWidth="2" />
        </svg>
      );
    case 'exchanger':
      return (
        <svg viewBox="0 0 320 200" fill="none" className="w-full h-full max-h-48 drop-shadow-sm opacity-90">
          ...
          <line x1="58" y1="85" x2="262" y2="85" stroke="#5B9BD9" strokeWidth="2" />
          <line x1="58" y1="92" x2="262" y2="92" stroke="#1F5FA8" strokeWidth="1.5" />
          <line x1="58" y1="100" x2="262" y2="100" stroke="#5B9BD9" strokeWidth="2" />
          <line x1="58" y1="108" x2="262" y2="108" stroke="#1F5FA8" strokeWidth="1.5" />
          <line x1="58" y1="115" x2="262" y2="115" stroke="#5B9BD9" strokeWidth="2" />

          {/* Top outlet and bottom inlet nozzle flanges */}
          <rect x="80" y="40" width="25" height="25" fill="#1B2A3D" stroke="#1F5FA8" strokeWidth="2" />
          <rect x="215" y="135" width="25" height="25" fill="#1B2A3D" stroke="#1F5FA8" strokeWidth="2" />

          {/* Flow directions */}
          <path d="M92 20 V38" stroke="#5B9BD9" strokeWidth="2.5" />
    ...
    case 'prs':
      return (
        <svg viewBox="0 0 320 200" fill="none" className="w-full h-full max-h-48 drop-shadow-sm opacity-90">
          ...
          {/* Top bypass pathing */}
          <path d="M80 100 V60 H240 V100" fill="none" stroke="#1F5FA8" strokeWidth="4.5" />

          {/* Self Actuated Regulator diaphragm valve representation (Main block) */}
          <circle cx="160" cy="100" r="16" fill="#0D1B2A" stroke="#1F5FA8" strokeWidth="3" />
          <rect x="150" y="65" width="20" height="20" fill="#EF4444" stroke="#0D1B2A" strokeWidth="2" />
          <line x1="160" y1="82" x2="160" y2="114" stroke="#5B9BD9" strokeWidth="2.5" />
          ...
          <line x1="105" y1="75" x2="110" y2="71" stroke="#5B9BD9" strokeWidth="2" />
    ...
    case 'preheater':
      return (
        <svg viewBox="0 0 320 200" fill="none" className="w-full h-full max-h-48 drop-shadow-sm opacity-90">
          ...
          <line x1="110" y1="55" x2="110" y2="145" stroke="#5B9BD9" strokeWidth="3" strokeDasharray="3 4" />
          <line x1="135" y1="55" x2="135" y2="145" stroke="#5B9BD9" strokeWidth="3" />
          <line x1="160" y1="55" x2="160" y2="145" stroke="#5B9BD9" strokeWidth="3" strokeDasharray="3 4" />
          <line x1="185" y1="55" x2="185" y2="145" stroke="#5B9BD9" strokeWidth="3" />
          <line x1="210" y1="55" x2="210" y2="145" stroke="#5B9BD9" strokeWidth="3" strokeDasharray="3 4" />

          {/* Thermal air flow direction indications */}
          <path d="M50 75 H78" stroke="#5B9BD9" strokeWidth="4" strokeLinecap="round" />
          <path d="M72 67 L82 75 L72 83 Z" fill="#5B9BD9" />
          <text x="35" y="60" fill="#5B9BD9" className="text-[10px] font-mono font-bold">Cold Air</text>
    ...
    case 'pollution':
      return (
        <svg viewBox="0 0 320 200" fill="none" className="w-full h-full max-h-48 drop-shadow-sm opacity-90">
          ...
          <polygon points="110,90 210,90 175,160 145,160" fill="#0D1B2A" stroke="#1F5FA8" strokeWidth="3.5" />
    ...
    case 'other':
      return (
        <svg viewBox="0 0 320 200" fill="none" className="w-full h-full max-h-48 drop-shadow-sm opacity-90">
          ...
          <path d="M50 90 H70" stroke="#5B9BD9" strokeWidth="4" />
          ...
          <line x1="100" y1="160" x2="220" y2="160" stroke="#1F5FA8" strokeWidth="3" />
        </svg>
      );
  }
}
        ...
        <div className="pt-10">
          {filteredProducts.length === 0 ? (
            <div className="bg-white border border-[#E1E4E3] rounded-lg p-12 text-center max-w-md mx-auto space-y-4 shadow-sm">
              <PackageCheck className="w-12 h-12 text-[#1F5FA8] mx-auto opacity-70" />
