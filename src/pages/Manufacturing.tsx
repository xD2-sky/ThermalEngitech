...
export default function Manufacturing() {
  ...
  return (
    <div className="space-y-0 text-left bg-[#F1F1ED] min-h-screen">
      ...
      {/* Banner */}
      <div className="bg-[#0D1B2A] text-white border-b border-[#B3401F]/25 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-7 space-y-4">
            <p className="text-[11px] font-mono uppercase tracking-[0.18em] text-[#E2793D]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="bg-white border border-[#E1E4E3] rounded-lg overflow-hidden shadow-xs">
            <div className="bg-slate-50 px-6 py-4 border-b border-slate-200">
              <h3 className="text-xs uppercase font-mono font-bold text-[#0D1B2A] flex items-center gap-2">
                <HardHat className="w-4 h-4 text-[#B3401F]" />
            ...
            <div className="divide-y divide-slate-100">
              {shopCapacities.map((cap, idx) => (
                <div key={idx} className="p-6 grid grid-cols-1 sm:grid-cols-4 gap-2 sm:gap-6 hover:bg-slate-50 transition">
                  <span className="text-xs font-mono font-bold text-[#B3401F] uppercase sm:col-span-1 leading-tight">
                    {cap.label}
                  </span>
        ...
        <div className="lg:col-span-5 bg-white border border-[#E1E4E3] rounded-lg p-6 md:p-8 space-y-6 self-start shadow-xs text-left">
          <div className="p-3 bg-[#B3401F]/10 rounded-xl text-[#B3401F] w-12 h-12 flex items-center justify-center">
          ...
          <ul className="space-y-3.5 text-xs text-slate-600 font-sans">
            <li className="flex items-start gap-2.5">
              <span className="text-[#B3401F] font-bold">✓</span>
        ...
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 text-left">
            {MANUFACTURING_STEPS.map((step, i) => (
              <div 
                key={i}
                className="bg-white border border-[#E1E4E3] p-6 rounded-lg hover:border-[#B3401F]/35 transition shadow-sm space-y-3.5 flex flex-col justify-between"
              >
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="font-mono text-xs font-bold text-[#B3401F] uppercase tracking-wider">
                      Stage {step.step}
                    </span>
