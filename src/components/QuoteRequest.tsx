        ...
        <div className="lg:col-span-7 bg-white border border-[#E1E4E3] rounded-xl p-6 md:p-8 shadow-sm relative overflow-hidden">
          ...
          {submittedTicket && (
            <div className="absolute inset-0 bg-white/98 backdrop-blur-sm z-10 flex flex-col items-center justify-center text-center p-6 animate-fadeIn">
              <CheckCircle className="w-16 h-16 text-[#B3401F] mb-4" />
              ...
              <p className="text-sm text-[#17222E] max-w-md mt-2 leading-relaxed">
                Thank you! Your thermodynamic specifications ticket <b className="text-[#B3401F] font-bold">{submittedTicket}</b> has been queued. Our systems engineers will contact your representative.
              </p>
              
              <button
                onClick={() => setSubmittedTicket(null)}
                className="mt-6 px-5 py-2.5 bg-[#0D1B2A] hover:bg-[#B3401F] text-white text-xs font-bold rounded-lg transition"
              >
          ...
          <form onSubmit={handleSubmit} className="space-y-6 text-left">
            <h3 className="text-base font-heading font-semibold text-[#0D1B2A] flex items-center gap-2">
              <Clipboard className="w-5 h-5 text-[#B3401F]" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full text-xs px-3 py-2.5 bg-[#F7F7F4] border border-[#E1E4E3] rounded-lg text-[#17222E] font-medium focus:outline-none focus:border-[#B3401F] focus:bg-white transition"
                />
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full text-xs px-3 py-2.5 bg-[#F7F7F4] border border-[#E1E4E3] rounded-lg text-[#17222E] font-semibold focus:outline-none focus:border-[#B3401F] focus:bg-white transition"
                >
                  {PRODUCTS.map((prod) => (
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                className="w-full text-xs px-3 py-2.5 bg-[#F7F7F4] border border-[#E1E4E3] rounded-lg text-[#17222E] font-medium focus:outline-none focus:border-[#B3401F] focus:bg-white transition leading-relaxed"
              />
            </div>

            <button
              type="submit"
              className="w-full py-3.5 bg-[#0D1B2A] hover:bg-[#B3401F] text-white font-heading font-semibold text-xs uppercase tracking-wider rounded-lg shadow-md hover:shadow-lg transition duration-200 cursor-pointer flex items-center justify-center gap-2"
            >
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="bg-white border border-[#E1E4E3] rounded-xl p-6 space-y-5 text-left">
            <h3 className="text-md font-heading font-bold text-[#0D1B2A] flex items-center gap-2">
              <ShieldCheck className="w-5 h-5 text-[#B3401F]" />
                ...
                {savedInquiries.map((inq) => (
                  <div key={inq.id} className="bg-[#F7F7F4] border border-[#E1E4E3] p-4 rounded-lg space-y-2 text-xs">
                    <div className="flex justify-between items-center">
                      <span className="font-mono text-[#B3401F] font-bold text-[11px]">{inq.id}</span>
                      <span className="px-2 py-0.5 bg-[#B3401F]/10 text-[#B3401F] rounded-full text-[9px] font-bold">
                        RECEIVED
                      </span>
                    </div>
