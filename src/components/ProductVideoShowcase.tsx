    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between border-b border-slate-200 pb-3">
        <h3 className="text-sm uppercase font-mono font-bold tracking-wider text-[#0D1B2A] flex items-center gap-2">
          <Video className="w-4 h-4 text-[#1F5FA8]" />
          <span>Product Video Showcase</span>
        </h3>
        <span className="text-[10px] font-mono font-semibold text-[#1F5FA8] bg-[#1F5FA8]/5 px-2.5 py-1 rounded-full uppercase tracking-wider">
          Media Hub
        </span>
      </div>
      ...
      <div className="bg-white border border-[#E1E4E3] rounded-lg p-4 sm:p-6 shadow-xs relative overflow-hidden min-h-[300px] md:min-h-[360px] flex flex-col justify-between">
        ...
        {videoType === 'local' && videoSrc ? (
          ...
          <div className="relative flex-1 w-full rounded-xl bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-8 flex flex-col items-center justify-center text-center overflow-hidden min-h-[260px] md:min-h-[310px] group border border-slate-800">
            ...
            <div className="absolute inset-0 opacity-[0.04] bg-[radial-gradient(#2E76C9_1px,transparent_1px)] [background-size:20px_20px]" />
            <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black/40" />

            {/* Pulsing visual circles in background */}
            <div className="absolute w-72 h-72 rounded-full bg-[#1F5FA8]/5 blur-3xl -top-12 -left-12 pointer-events-none" />
            ...
            <div className="relative z-10 mb-6 flex items-center justify-center">
              {/* Outer wave rings */}
              <div className="absolute inset-0 rounded-full bg-[#1F5FA8]/20 animate-ping opacity-60 scale-125" />
              <div className="absolute w-20 h-20 rounded-full bg-[#1F5FA8]/10 border border-[#1F5FA8]/30" />
              
              {/* Core play button circle */}
              <div className="relative w-16 h-16 rounded-full bg-[#1F5FA8] hover:bg-[#2E76C9] transition-all duration-300 shadow-lg flex items-center justify-center cursor-pointer group-hover:scale-105">
            ...
            <div className="relative z-10 max-w-md space-y-2">
              <h4 className="text-white font-heading font-extrabold text-base sm:text-lg tracking-wide flex items-center justify-center gap-2">
                <MonitorPlay className="w-5 h-5 text-[#2E76C9]" />
                <span>Product Video Demonstration</span>
              </h4>
              <p className="text-xs text-slate-500 leading-relaxed font-sans max-w-sm mx-auto">
                Video content can be added here in the future. Map an MP4 stream or YouTube embed link in <code className="text-[#2E76C9] font-mono px-1 py-0.5 bg-white/5 rounded">src/config/videos.ts</code> to instantly activate live playback.
              </p>
            </div>
